...
export default function ContactInformation() {
  return (
    <div className="w-full h-auto flex">
      <div
        className="
        shadow-md rounded-md max-w-xl w-full
        p-5
        xl:p-20
      "
      >
        ...
        <div className="space-y-4">
          <div className="flex items-center">
            <span className="w-24 min-w-24 flex justify-center text-gray-700 dark:text-gray-200 font-semibold">
            ...
            <Link
              href={`mailto:${PERSONAL_LINKS.mail}`}
          ...
          <div className="flex items-center">
            ...
            <Link
              ...
              className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-200 underline"
            >
              linkedin.com/in/bartlomiej-treska/
            </Link>
          </div>
        </div>
      </div>
